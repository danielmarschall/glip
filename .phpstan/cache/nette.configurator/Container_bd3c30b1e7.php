<?php
// source: phar:///daten/scripts/phpstan.phar/conf/config.neon
// source: phar:///daten/scripts/phpstan.phar/conf/config.level5.neon
// source: /daten/git/glip/phpstan.neon.dist
// source: phar:///daten/scripts/phpstan.phar/src/PhpDoc/../../conf/config.stubValidator.neon
// source: array
...
class Container_bd3c30b1e7 extends _PHPStan_582a9cb8b\Nette\DI\Container
{
	protected $tags = [
		...
		'phpstan.broker.propertiesClassReflectionExtension' => ['085' => true, '090' => true, '0204' => true],
		...
		'phpstan.typeSpecifier.methodTypeSpecifyingExtension' => ['0214' => true],
		'phpstan.rules.rule' => [
			'0283' => true,
			'0284' => true,
			'0285' => true,
	...
	protected $wiring = [
		...
		'PHPStan\Reflection\PropertiesClassReflectionExtension' => [['075', '085', '086', '090', '0204']],
		...
		'PHPStan\Type\MethodTypeSpecifyingExtension' => [['0214']],
		...
		'PHPStan\PhpDoc\StubSourceLocatorFactory' => [['0351']],
	];
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'bootstrapFiles' => [
				'phar:///daten/scripts/phpstan.phar/stubs/runtime/ReflectionUnionType.php',
				'phar:///daten/scripts/phpstan.phar/stubs/runtime/ReflectionAttribute.php',
				'phar:///daten/scripts/phpstan.phar/stubs/runtime/Attribute.php',
				'phar:///daten/scripts/phpstan.phar/stubs/runtime/ReflectionIntersectionType.php',
			],
			'excludes_analyse' => [],
			'excludePaths' => ['analyseAndScan' => ['/daten/git/glip/.phpstan']],
			'level' => 5,
			'paths' => ['/daten/git/glip'],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'stubFiles' => [
				'phar:///daten/scripts/phpstan.phar/stubs/ReflectionAttribute.stub',
				'phar:///daten/scripts/phpstan.phar/stubs/ReflectionClass.stub',
				'phar:///daten/scripts/phpstan.phar/stubs/ReflectionClassConstant.stub',
				'phar:///daten/scripts/phpstan.phar/stubs/ReflectionFunctionAbstract.stub',
				'phar:///daten/scripts/phpstan.phar/stubs/ReflectionMethod.stub',
				'phar:///daten/scripts/phpstan.phar/stubs/ReflectionParameter.stub',
				'phar:///daten/scripts/phpstan.phar/stubs/ReflectionProperty.stub',
				'phar:///daten/scripts/phpstan.phar/stubs/iterable.stub',
				'phar:///daten/scripts/phpstan.phar/stubs/ArrayObject.stub',
				'phar:///daten/scripts/phpstan.phar/stubs/WeakReference.stub',
				'phar:///daten/scripts/phpstan.phar/stubs/ext-ds.stub',
				'phar:///daten/scripts/phpstan.phar/stubs/PDOStatement.stub',
				'phar:///daten/scripts/phpstan.phar/stubs/date.stub',
				'phar:///daten/scripts/phpstan.phar/stubs/mysqli.stub',
				'phar:///daten/scripts/phpstan.phar/stubs/zip.stub',
				'phar:///daten/scripts/phpstan.phar/stubs/dom.stub',
				'phar:///daten/scripts/phpstan.phar/stubs/spl.stub',
				'phar:///daten/scripts/phpstan.phar/stubs/SplObjectStorage.stub',
				'phar:///daten/scripts/phpstan.phar/stubs/Exception.stub',
				'phar:///daten/scripts/phpstan.phar/stubs/arrayFunctions.stub',
				'phar:///daten/scripts/phpstan.phar/stubs/core.stub',
				'phar:///daten/scripts/phpstan.phar/stubs/typeCheckingFunctions.stub',
			],
			'earlyTerminatingMethodCalls' => [],
			'earlyTerminatingFunctionCalls' => [],
			'memoryLimitFile' => '/daten/git/glip/.phpstan/.memory_limit',
			'tempResultCachePath' => '/daten/git/glip/.phpstan/resultCaches',
			'resultCachePath' => '/daten/git/glip/.phpstan/resultCache.php',
			...
			'errorFormat' => null,
			'__validate' => false,
			'tmpDir' => '/daten/git/glip/.phpstan',
			'debugMode' => true,
			'productionMode' => false,
			'tempDir' => '/daten/git/glip/.phpstan',
			'rootDir' => '/daten/scripts',
			'currentWorkingDirectory' => '/daten/git/glip',
			'cliArgumentsVariablesRegistered' => true,
			'additionalConfigFiles' => [
				'phar:///daten/scripts/phpstan.phar/conf/config.level5.neon',
				'/daten/git/glip/phpstan.neon.dist',
				'phar:///daten/scripts/phpstan.phar/src/PhpDoc/../../conf/config.stubValidator.neon',
			],
	...
	public function createService044(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_bd3c30b1e7 $container)
			{
			...
			public function create(array $fileReplacements): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					'/daten/git/glip/.phpstan/resultCache.php',
					'/daten/git/glip/.phpstan/resultCaches',
	...
	{
		return new PHPStan\File\FileHelper('/daten/git/glip');
	}


	public function createService064(): PHPStan\File\FileExcluderFactory
	{
		return new PHPStan\File\FileExcluderFactory($this->getService('065'), [], ['analyseAndScan' => ['/daten/git/glip/.phpstan']]);
	}
	...
	public function createService0351(): PHPStan\PhpDoc\StubSourceLocatorFactory
	{
	...
	{
		return new PHPStan\Cache\FileCacheStorage('/daten/git/glip/.phpstan/cache/PHPStan');
	}


	public function createServiceContainer(): Container_bd3c30b1e7
	{
		return $this;
	}
	...
	{
		return new PHPStan\File\FileFinder($this->getService('fileExcluderAnalyse'), $this->getService('063'), ['php', 'php']);
	}


	public function createServiceFileFinderScan(): PHPStan\File\FileFinder
	{
		return new PHPStan\File\FileFinder($this->getService('fileExcluderScan'), $this->getService('063'), ['php', 'php']);
	}
	...
	{
		return new PHPStan\File\ParentDirectoryRelativePathHelper('/daten/git/glip');
	}
	...
	{
		return new PHPStan\File\SimpleRelativePathHelper('/daten/git/glip');
	}
